...
// Switch tab in product detail
window.addEventListener("template-loaded", () => {
    const tabsSelector = "prod-tab__item"; //head
    const contentsSelector = "prod-tab__content"; //content
...
// Switch theme
//add id= switch-theme-btn + wrap 'Dark mode' with span
window.addEventListener("template-loaded", () => {
